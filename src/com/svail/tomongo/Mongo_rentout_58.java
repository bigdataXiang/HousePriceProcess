...
public class Mongo_rentout_58 {
	public static BasicDBObject transfer(Poi_rentout_58 poi)
	{
		...
		if (poi.TIME != null)
		{
			if (poi.TIME.indexOf("-")!=-1&&poi.TIME.indexOf(":")==-1)
			{
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			Vector<String> rds = FileTool.Load("E:/crawldata_beijing/3_58_rentout_result.txt","UTF-8");
			List<DBObject> dbList = new ArrayList<DBObject>();  
			for (int n = 0; n < rds.size(); n ++)
			{
				String element=rds.elementAt(n);
				Poi_rentout_58 poi = new Poi_rentout_58(element);
				if(poi.COORDINATE!=null)
				{
