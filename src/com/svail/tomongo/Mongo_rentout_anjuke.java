...
public class Mongo_rentout_anjuke {
	   
	public static BasicDBObject transfer(Poi_rentout_anjuke poi)
	{
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			Vector<String> rds = FileTool.Load("E:/crawldata_beijing/anjuke_rentout_problem_poi925.txt.result.txt","UTF-8");
			...
			for (int n = 0; n < rds.size(); n ++)
			{
				...
				Poi_rentout_anjuke poi = new Poi_rentout_anjuke(element);
				if(poi.COORDINATE!=null)
				{
