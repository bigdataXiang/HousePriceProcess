...
public class Mongo_fang_resold {
	   
	public static BasicDBObject transfer(Poi_resold_fang poi)
	{
		...
		if (poi.BUILDING_TIME != null)
			document.put("BUILDING_TIME",poi.BUILDING_TIME);
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			Vector<String> rds = FileTool.Load("E:/crawldata_beijing/fang_resold_problem_poi923.txt.result.txt","UTF-8");
			...
			for (int n = 0; n < rds.size(); n ++)
			{
				...
				Poi_resold_fang poi = new Poi_resold_fang(element);
				if(poi.COORDINATE!=null)
				{
