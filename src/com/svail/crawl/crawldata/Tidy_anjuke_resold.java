...
public class Tidy_anjuke_resold{
	...
	Tidy_anjuke_resold(String line) throws IOException
	{
		try{
			...
			else
			{
			 ...
			 {
			   AREA=getStrByKey(line,"<HOUSE_AREA>","</HOUSE_AREA>").replace("平米","").replace("平方米","").replace("&nbsp;", "").replace("&amp;","").replace("nb;","").replace("nbsp","").replace("|","").replace(";","").replace("�","");
			 } 
			...
			PROPERTY_TYPE=getStrByKey(line,"<TYPE>","</TYPE>").replace("&nbsp;", "").replace("&amp;","").replace("nb;","").replace("nbsp","").replace("|","").replace(";","");	
	...
	public static void main(String[] args) throws IOException {
		String POI="";
		Vector<String> rds = FileTool.Load("D:/Data_classify/finish_classify/anjuke/anjuke_result/anjuke_resold/anjuke_resold0913_0919.txt","UTF-8");
		...
		for (int n = 0; n < rds.size(); n ++)
		{
			...
			Tidy_anjuke_resold poi = new Tidy_anjuke_resold(element);
			...
			write_append(POI,"D:/Crawl_test/anjuke_resold0913_0919.txt");	
			POI="";
		}
	}
