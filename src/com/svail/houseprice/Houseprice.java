...
public class Houseprice {
	...
	public static void main(String[] args){
		...
		String path="E:\\房地产可视化\\近一年数据分类汇总\\fang\\rentout\\json\\fang_rentout_tidy\\checked\\";
		finalCheck(path+"fang_rentout_2015_0718.txt_false.txt_ok.txt","2015-07-18");
		//new File("").getAbsolutePath()+
		//toJson("E:\\房地产可视化\\近一年数据分类汇总\\anjuke\\rentout\\json\\anjuke_rentout1119_result.txt",false,"2015-11-19");
