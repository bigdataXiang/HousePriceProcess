...
public class GeoCoding{
	 static String Folder="D:/Crawldata_BeiJing/忘却的那两个月/";
	 public static String[] filename={"1015","1030","1104","1111","1117"};
	 //"1010","1012","1030","1104","1106","1111","1113","1117","1119"
	 //{"2015_11","2015_12","2016_1","2016_2","2016_3","2016_4","2016_5","2016_6"}
	 //{"0324","0401","0414","0428","0509","0520","0527","0603"}
	 ...
	 public static void main(String argv[]) throws Exception{
	     ...
	     processCSV(Folder+"woaiwojia_resold1117_Null_Null.txt",false);
			...
			for (int n = 0; n < pois.size(); n ++) {
				if (batch) {
					...
					if(json){
						...
						if(rs.indexOf("sales_address")!=-1){
							ADDRESS=obj.getString("sales_address").replace("(地图)", "");
						}
					...
					validpois.add(rs);
					count ++;
					String address=TITLE+REGION+ADDRESS+COMMUNITY;
														...
														if (gq.getResult().get(m) != null && gq.getResult().get(m).getLocation() != null)
														{
															...
															if(json){
																...
																FileTool.Dump(jobj.toString().replace(" ", ""), file.replace(".txt", "") + "_result.txt", "UTF-8");
																 ...
																 FileTool.Dump(poi.replace(" ", ""), file.replace(".txt", "") + "_result.txt", "UTF-8");
															}															
														}
														else
														{
